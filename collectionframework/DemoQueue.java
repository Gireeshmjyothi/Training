...
/*
 * This class is used to shows how does Queue interface works
 */
public class DemoQueue {
	...
	public static void main(String[] args) {
		...
		//peek() method is used to get the head value from the list and it does not delete the value
		System.out.println("Queue :"+values.peek());
		//poll() method is used to get the head value from the list and it will delete the head value
